...
class sync_source_t(object):
    ...
    def __init__(self, *args):
        ...
        """
        this = _ida_kernwin.new_sync_source_t(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    __del__ = lambda self : None;
sync_source_t_swigregister = _ida_kernwin.sync_source_t_swigregister
sync_source_t_swigregister(sync_source_t)
...
class action_ctx_base_t(object):
    ...
    cur_value = _swig_property(_ida_kernwin.action_ctx_base_t_cur_value_get, _ida_kernwin.action_ctx_base_t_cur_value_set)
...
def sync_sources(*args):
  """
  sync_sources(what, with, sync) -> bool
...
def choose_create_embedded_chobj(*args):
  """
  choose_create_embedded_chobj(self) -> uint64
  """
...
def textctrl_info_t_get_flags(*args):
  """
  textctrl_info_t_get_flags(self) -> unsigned int
  """
